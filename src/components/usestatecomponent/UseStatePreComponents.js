...
const UseStateComponent = () => {
    ...
    return (
        <div>
            ...
            <button onClick={()=>{setCounter(previousCounter => previousCounter + 1)}}>Increment Counter</button>  
            <button onClick={()=>{setCounter(previousCounter => previousCounter - 1)}}>Decerement Counter</button>   
